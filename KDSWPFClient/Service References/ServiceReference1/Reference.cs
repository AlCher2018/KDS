...
namespace KDSWPFClient.ServiceReference1 {
    ...
    [System.SerializableAttribute()]
    public partial class OrderModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged, View.IContainIDField {
    ...
    [System.SerializableAttribute()]
    public partial class OrderDishModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged, View.IContainIDField {
    ...
    public interface IKDSCommandService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IKDSCommandService/ChangeOrderStatus", ReplyAction="http://tempuri.org/IKDSCommandService/ChangeOrderStatusResponse")]
        System.Threading.Tasks.Task<bool> ChangeOrderStatusAsync(string machineName, int orderId, int orderStatusId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IKDSCommandService/ChangeOrderDishStatus", ReplyAction="http://tempuri.org/IKDSCommandService/ChangeOrderDishStatusResponse")]
        System.Threading.Tasks.Task<bool> ChangeOrderDishStatusAsync(string machineName, int orderId, int dishId, int dishStatusId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IKDSCommandService/CreateNoticeFileForOrder", ReplyAction="http://tempuri.org/IKDSCommandService/CreateNoticeFileForOrderResponse")]
        System.Threading.Tasks.Task<bool> CreateNoticeFileForOrderAsync(string machineName, int orderId, string dishIdsStr);
    ...
    public partial class KDSCommandServiceClient : System.ServiceModel.ClientBase<KDSWPFClient.ServiceReference1.IKDSCommandService>, KDSWPFClient.ServiceReference1.IKDSCommandService {
        ...
        public bool ChangeOrderStatus(string machineName, int orderId, int orderStatusId) {
            return base.Channel.ChangeOrderStatus(machineName, orderId, orderStatusId);
        }
        
        public System.Threading.Tasks.Task<bool> ChangeOrderStatusAsync(string machineName, int orderId, int orderStatusId) {
            return base.Channel.ChangeOrderStatusAsync(machineName, orderId, orderStatusId);
        }
        
        public bool ChangeOrderDishStatus(string machineName, int orderId, int dishId, int dishStatusId) {
            return base.Channel.ChangeOrderDishStatus(machineName, orderId, dishId, dishStatusId);
        }
        
        public System.Threading.Tasks.Task<bool> ChangeOrderDishStatusAsync(string machineName, int orderId, int dishId, int dishStatusId) {
            return base.Channel.ChangeOrderDishStatusAsync(machineName, orderId, dishId, dishStatusId);
        }
        
        public bool CreateNoticeFileForOrder(string machineName, int orderId, string dishIdsStr) {
            return base.Channel.CreateNoticeFileForOrder(machineName, orderId, dishIdsStr);
        }
        
        public System.Threading.Tasks.Task<bool> CreateNoticeFileForOrderAsync(string machineName, int orderId, string dishIdsStr) {
            return base.Channel.CreateNoticeFileForOrderAsync(machineName, orderId, dishIdsStr);
        }
