...
//            List<OrderDishModel> retVal = new List<OrderDishModel>();
        ...
        public static Dictionary<int, OrderTestModel> GetOrdersDict()
        {
            ...
            {
                {1, new OrderTestModel() { Id = 1, Number = 10123, CreateDate = DateTime.Now, HallName = "Зал 1",
                    TableName = "Стол 1", Waiter = "Коцяруба Елизавета"} },
                {2, new OrderTestModel() { Id = 2, Number = 10124, CreateDate = DateTime.Now, HallName = "Зал 1",
                    TableName = "Стол 2", Waiter = "Товстокор Артем"} },
                {3, new OrderTestModel() { Id = 3, Number = 10125, CreateDate = DateTime.Now, HallName = "Зал 1",
                    TableName = "Стол 3", Waiter = "Визняк Анна"} },
                {4, new OrderTestModel() { Id = 4, Number = 123, CreateDate = DateTime.Now, HallName = "Зал 1",
                    TableName = "Стол 4", Waiter = "Кебас Христина"} },
                {5, new OrderTestModel() { Id = 5, Number = 124, CreateDate = DateTime.Now, HallName = "Зал 1",
                    TableName = "Стол 5", Waiter = "Кузнецова Катерина"} },
                {6, new OrderTestModel() { Id = 6, Number = 125, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 1", Waiter = "Чередніченко Віталій"} },
                {7, new OrderTestModel() { Id = 7, Number = 126, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 2", Waiter = "Лещенко Ирина"} },
                {8, new OrderTestModel() { Id = 8, Number = 147, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 3", Waiter = "Тригуб Людмила"} },
                {9, new OrderTestModel() { Id = 9, Number = 148, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 4", Waiter = "Плотникова Елена"} },
                {10, new OrderTestModel() { Id = 10, Number = 149, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 5", Waiter = "Гаркуша Олексій"} },
                {11, new OrderTestModel() { Id = 11, Number = 150, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 6", Waiter = "Салаков Андрей"} },
                {12, new OrderTestModel() { Id = 12, Number = 156, CreateDate = DateTime.Now, HallName = "Зал 2",
                    TableName = "Стол 7", Waiter = "Оніщенко Віктор"} },
                {13, new OrderTestModel() { Id = 13, Number = 157, CreateDate = DateTime.Now, HallName = "Зал 2",
